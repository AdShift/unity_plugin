...
// This will be generated by Xcode when building
#if __has_include("UnityFramework/UnityFramework-Swift.h")
#import "UnityFramework/UnityFramework-Swift.h"
#elif __has_include("adshift_flutter_sdk-Swift.h")
#import "adshift_flutter_sdk-Swift.h"
#endif
...
/// Converts NSString to C string (caller must NOT free - uses autorelease pool)
static const char* _Nonnull getCString(const char* _Nonnull str) {
    if (str == NULL) return "";
    return strdup(str);
}
...
static const char* _Nonnull jsonFromDictionary(NSDictionary* _Nullable dict) {
    ...
    return getCString([jsonString UTF8String]);
}
...
const char* _adshift_getIDFA(void) {
    ...
    return getCString([idfaStr UTF8String]);
    #else
    return "";
    #endif
}
